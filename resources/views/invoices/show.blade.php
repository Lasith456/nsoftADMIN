            ...
            <tbody>
                ...
                @foreach($invoice->items as $item)
                    ...
                    <tr>
                        ...
                        <td class="border px-2 py-1 text-center">{{ $item->quantity ?? 0 }} {{ $item->product->unit_of_measure ?? 'PCS' }}</td>                        <td class="border px-2 py-1 text-right">{{ number_format($item->vat_amount, 2) }}</td> {{-- NEW --}}
