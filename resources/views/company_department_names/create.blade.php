...
<div class="bg-white shadow-md rounded-lg p-6 max-w-lg mx-auto">
    <h2 class="text-xl font-bold mb-4">Add Companywise Department Name</h2>

    <form action="{{ route('company_department_names.store') }}" method="POST">
        @csrf
        ...
        <div class="mb-4">
            ...
            <input type="text" name="appear_name" class="w-full border p-2 rounded" required>
        </div>
