...
<div class="bg-white shadow-md rounded-lg p-4">
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 border-b border-gray-200 pb-3">
        <div>
            <h2 class="text-2xl font-bold text-black">Customer Invoice History</h2>
            <nav class="text-sm text-gray-500" aria-label="Breadcrumb">
                <ol class="list-none p-0 inline-flex">
                    ...
                    <li class="text-black">Customer Invoice History</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <table class="w-full min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-4 py-2 text-sm">{{ $invoice->invoiceable->customer_name ?? 'N/A' }}</td>
                ...
                @empty
                <tr><td colspan="7" class="text-center py-4">No customer invoices found.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
