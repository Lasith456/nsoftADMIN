...
<div id="receipt" class="bg-white shadow-lg rounded-lg p-8 max-w-4xl mx-auto border border-gray-300">
    ...
    <div class="flex justify-between items-center border-b pb-4 mb-6">
        ...
        <div class="text-right">
            <h2 class="text-xl font-bold text-gray-700">SUPPLIER PAYMENT RECEIPT</h2>
    ...
    <div class="grid grid-cols-2 gap-6 mb-6">
        <div>
            <h3 class="font-bold text-gray-700 mb-2">Supplier Details</h3>
            <p><strong>Name:</strong> {{ $supplier->supplier_name }}</p>
            <p><strong>Code:</strong> {{ $supplier->supplier_id }}</p>
            <p><strong>Contact:</strong> {{ $supplier->contact_no ?? 'N/A' }}</p>
        </div>
        <div>
    ...
    <div class="flex justify-between items-center border-t pt-4">
        ...
        <button onclick="window.print()" 
                class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 print:hidden">
            Print Receipt
        </button>
    </div>
</div>
