...
<div class="container mx-auto p-2" x-data="bulkPaymentForm()">
    <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-4">
        <form id="bulk-payment-form" action="{{ route('payments.storeBulk') }}" method="POST">
            ...
            {{-- Customer Selection & Payment Details --}}
                ...
                <div class="mt-4 max-h-80 overflow-y-auto border rounded-md">
                     <table class="w-full min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody>
                            ...
                            <template x-if="!isLoading && invoices.length === 0"><tr><td colspan="4" class="text-center p-4">No outstanding invoices found for this customer.</td></tr></template>
