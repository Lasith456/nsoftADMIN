...
<div class="bg-white shadow-md rounded-lg p-4">
        ...
        <div>
            ...
            <nav class="text-sm text-gray-500" aria-label="Breadcrumb">
                <ol class="list-none p-0 inline-flex">
                    ...
                    <li class="text-black">Customers</li>
                </ol>
            </nav>
        </div>
        {{-- Add Customer Button --}}
        @can('customer-create')
            <a class="mt-3 md:mt-0 inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900" href="{{ route('customers.create') }}">
    ...
    <form x-data x-ref="searchForm" action="{{ route('customers.index') }}" method="GET" class="mb-4">
    ...
    <div class="overflow-x-auto">
        <table class="w-full min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    <th scope="col" class="px-4 py-2 text-left text-xs font-medium text-black uppercase tracking-wider w-1/6">Customer ID</th>
