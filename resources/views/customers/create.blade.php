        ...
        <form id="customer-form" action="{{ route('customers.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                ...
                <div>
                    ...
                    <input type="text" name="customer_name" id="customer_name" class="mt-1 block w-full px-3 py-1 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 rounded-md shadow-sm" placeholder="Full Name" value="{{ old('customer_name') }}" required>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="tel" name="customer_mobile" id="customer_mobile" class="mt-1 block w-full px-3 py-1 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 rounded-md shadow-sm" placeholder="07..." value="{{ old('customer_mobile') }}" required>
                </div>
                ...
                <div>
                    ...
                    <input type="tel" name="customer_phone" id="customer_phone" class="mt-1 block w-full px-3 py-1 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 rounded-md shadow-sm" placeholder="011..." value="{{ old('customer_phone') }}">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="email" name="customer_email" id="customer_email" class="mt-1 block w-full px-3 py-1 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 rounded-md shadow-sm" placeholder="example@mail.com" value="{{ old('customer_email') }}">
                </div>
                ...
                <div class="md:col-span-3">
                    ...
                    <textarea name="primary_address" id="primary_address" rows="2" class="mt-1 block w-full px-3 py-1 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 rounded-md shadow-sm" placeholder="Primary Address" required>{{ old('primary_address') }}</textarea>
                </div>
                <div class="md:col-span-3">
                    <label for="company_address" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Company Address</label>
                    <textarea name="company_address" id="company_address" rows="2" class="mt-1 block w-full px-3 py-1 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 rounded-md shadow-sm" placeholder="Company Address">{{ old('company_address') }}</textarea>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="remark" id="remark" rows="2" class="mt-1 block w-full px-3 py-1 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 rounded-md shadow-sm" placeholder="Any additional remarks">{{ old('remark') }}</textarea>
                </div>
