        ...
        <div class="overflow-x-auto">
            <table class="w-full min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        <th class="px-4 py-2 text-left text-xs font-medium text-black uppercase">PO ID</th>
                        <th class="px-4 py-2 text-left text-xs font-medium text-black uppercase">Customer</th>
                        <th class="px-4 py-2 text-left text-xs font-medium text-black uppercase">Delivery Date</th>
                        <th class="px-4 py-2 text-left text-xs font-medium text-black uppercase">Products</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        <td class="px-4 py-2 text-sm text-black">{{ $po->po_id }}</td>
                        <td class="px-4 py-2 text-sm text-black">{{ $po->customer->customer_name ?? 'N/A' }}</td>
                        <td class="px-4 py-2 text-sm text-black">{{ $po->delivery_date->format('Y-m-d') }}</td>
